...
const DEFAULT_BBB_TEST_DURATION = 300;
const DEFAULT_BBB_CLIENTS_WEBCAM = 1;
const DEFAULT_BBB_CLIENTS_MIC = 2;
const DEFAULT_BBB_CLIENTS_LISTEN_ONLY = 4;
...
module.exports = {
  ...
  options: (yargs) => {
    yargs
      ...
      .default("meeting", getEnv("BBB_MEETING_ID", "DemoMeeting"))
      .default(
        "d",
  ...
  handler: (argv) => {
    ...
    if(!process.env.BBB_MEETING_ID){
      bbbClient.bbbApiQuery(bbbClient.create("DemoMeeting", "DemoMeeting", "ap", "mp"))
    }
